  ...
  <div>
    ...
    <el-row>
      <el-col :span="8" :offset="2">
        <el-card :body-style="{ padding: '0px' }">
          <img
            src="http://1.15.248.74:9000/coursebucket/2023-06-25_225217.jpg"
            class="image"
          />
      ...
      <el-col :span="8" :offset="2">
        <el-card :body-style="{ padding: '0px' }">
          <img
            src="http://1.15.248.74:9000/coursebucket/2023-06-25_225304.jpg"
            class="image"
          />
          <div style="padding: 14px">
            <h3>计算机网络</h3>
    ...
    <el-row>
      <el-col :span="8" :offset="2">
        <el-card :body-style="{ padding: '0px' }">
          <img
            src="http://1.15.248.74:9000/coursebucket/2023-06-25_225329.jpg"
            class="image"
          />
          <div style="padding: 14px">
            <h3>计算机组成原理</h3>
      ...
      <el-col :span="8" :offset="2">
        <el-card :body-style="{ padding: '0px' }">
          <img
            src="http://1.15.248.74:9000/coursebucket/Snipaste_2023-06-27_14-52-24.jpg"
            class="image"
          />
          <div style="padding: 14px">
            <h3>数据结构</h3>
